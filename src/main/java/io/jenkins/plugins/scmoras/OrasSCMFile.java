...
/**
 * A single entry (file or directory) inside a repository artifact, resolved lazily against the
 * packaged tar.gz by {@link OrasSCMFileSystem}. No network access happens until the entry's type or
